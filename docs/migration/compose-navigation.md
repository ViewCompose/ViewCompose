...
defaults, and preserve unrelated Application and DI extras. Same-route entries in retained stacks
remain isolated. ViewCompose still has no arbitrary-UI scoped provider outside these navigation
boundaries.
