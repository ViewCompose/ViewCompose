...
`viewcompose-navigation` mounts `viewcompose-navigation-core` state as native Android View pages. It
...
- Direct ViewCompose dependencies include navigation core, host Android, renderer, widget core,
...
[`viewcompose-navigation` API tree](https://docs.viewcompose.com/api/viewcompose-navigation/current/).
