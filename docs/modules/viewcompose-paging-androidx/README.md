...
In an Android application, pass the ViewModel-owned `Pager.flow.cachedIn(viewModelScope)` Flow to
the same collector and keep the default lifecycle-visible policy.
