...
const sourcePaths = Object.freeze([
  ...
  'contracts/design-ir-v2.schema.json',
  'contracts/figma-import.schema.json',
  'contracts/generated-preview-request.schema.json',
  'contracts/layout-comparison.schema.json',
  'contracts/mcp-protocol.json',
  'contracts/project-analysis.schema.json',
  'contracts/project-analysis-catalog.schema.json',
  'contracts/project-analysis-corpus.schema.json',
  'contracts/project-analysis-quality.schema.json',
  'contracts/examples/project-analysis.json',
  'contracts/examples/project-analysis-catalog.json',
  'contracts/examples/project-analysis-corpus.json',
  'contracts/examples/project-analysis-quality.json',
  ...
  'contracts/screenshot-source-application-request.schema.json',
  'contracts/screenshot-source-application-journal.schema.json',
  'contracts/screenshot-source-application-receipt.schema.json',
  'contracts/examples/screenshot-source-application-request.json',
  'contracts/examples/screenshot-source-application-journal.json',
  'contracts/examples/screenshot-source-application-receipt.json',
  ...
  'generated/current-source/public-imports.jsonl',
  ...
  `${releasedBundleRoot}/public-imports.jsonl`,
  ...
  'harness/source-repair/ViewComposeSourceRepairHost.java',
  ...
  'scripts/figma-contract.mjs',
  'scripts/figma-import-adapter.mjs',
  'scripts/figma-render-plan.mjs',
