...
android {
    namespace = "com.viewcompose.publishing.smoke.oneui.overlay"
    compileSdk = 36
...
dependencies {
    ...
    implementation(viewCompose("viewcompose-oneui7"))
    implementation(viewCompose("viewcompose-overlay-oneui7-android"))
}
