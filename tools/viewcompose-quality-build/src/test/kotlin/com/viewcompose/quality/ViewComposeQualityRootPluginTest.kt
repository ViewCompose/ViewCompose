...
class ViewComposeQualityRootPluginTest {
    ...
    fun `maps explicit extension inputs to the configuration report task`() {
        ...
        val verifyAiToolingRelease = project.tasks.getByName("verifyAiToolingRelease")
        assertTrue(verifyAiToolingRelease is Exec)
        assertTrue(verifyAiToolingRelease.dependsOn.contains("verifyAiDistribution"))
        ...
        assertTrue(project.tasks.getByName("verifyAiScreenshotGeneration") is Exec)
        assertTrue(project.tasks.getByName("verifyAiScreenshotRender") is Exec)
        assertTrue(project.tasks.getByName("verifyAiScreenshotComparison") is Exec)
        assertTrue(project.tasks.getByName("verifyAiScreenshotPixelComparison") is Exec)
        assertTrue(project.tasks.getByName("verifyAiScreenshotRepair") is Exec)
        assertTrue(project.tasks.getByName("verifyAiScreenshotRepairCandidate") is Exec)
