...
/*
 * 测试职责：覆盖 navigation core 中的 Nav Back Stack Set Controller 行为，防止导航契约在后续重构中回退。
 * Test responsibility: covers Nav Back Stack Set Controller behavior in navigation core and guards navigation contracts against regressions.
 */
