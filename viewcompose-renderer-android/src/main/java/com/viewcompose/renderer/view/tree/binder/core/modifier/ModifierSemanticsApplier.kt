...
internal object ModifierSemanticsApplier {
    /**
     * Applies semantics, restoring captured native accessibility state when configuration becomes empty.
    ...
    fun apply(
        ...
        // Capture native state on first application so later modifier removal can restore it completely.
    ...
    private data class SemanticsViewState(
        ...
        /**
         * Restores View accessibility state captured before semantics modifiers took control.
