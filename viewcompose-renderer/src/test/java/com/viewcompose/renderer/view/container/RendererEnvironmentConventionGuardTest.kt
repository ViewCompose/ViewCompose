...
class RendererEnvironmentConventionGuardTest {
    ...
    private fun resolveContainerSourceDir(): File {
        val candidates = listOf(
            ...
            File("viewcompose-renderer/src/main/java/com/viewcompose/renderer/view/container"),
            File(System.getProperty("user.dir"), "src/main/java/com/viewcompose/renderer/view/container"),
            File(System.getProperty("user.dir"), "viewcompose-renderer/src/main/java/com/viewcompose/renderer/view/container"),
        )
