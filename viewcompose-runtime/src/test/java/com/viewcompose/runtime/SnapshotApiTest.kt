...
/*
 * 测试职责：覆盖 runtime 中的 Snapshot Api 行为，防止关键契约在后续重构中回退。
 * Test responsibility: covers Snapshot Api behavior in runtime and guards the contract against regressions.
 */
