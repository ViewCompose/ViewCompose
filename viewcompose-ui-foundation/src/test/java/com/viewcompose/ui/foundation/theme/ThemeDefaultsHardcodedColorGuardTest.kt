...
class ThemeDefaultsHardcodedColorGuardTest {
    ...
    private fun resolveDefaultsSourceDir(): File {
        val candidates = listOf(
            File("src/main/java/com/viewcompose/ui/foundation/defaults"),
            File("viewcompose-ui-foundation/src/main/java/com/viewcompose/ui/foundation/defaults"),
            File(System.getProperty("user.dir"), "src/main/java/com/viewcompose/ui/foundation/defaults"),
            File(System.getProperty("user.dir"), "viewcompose-ui-foundation/src/main/java/com/viewcompose/ui/foundation/defaults"),
        )
