...
translation_source_hash: aa73e3a430a1f4b6d3146036dc5235b7c86d30d022b6738a534389800ea07a5d
...
Android Renderer 仍是唯一 Adapter、Stable ID、Diff、Holder 与 Session Owner。
[已归档 Paging 3 集成计划](https://github.com/ViewCompose/ViewCompose/blob/main/docs/archive/paging3-integration.md)
记录完整闭环；受控 Demo、百万位置真机路径、稳定首份 Release 基线、Maven 证明与发版收尾均已完成。
Row/Grid 支持、真实 I/O 或方向性纵向性能结论现在需要新建可归因计划。有限列表应用仍可读取 `isAtEnd`、`lastVisibleItemIndex` 和
