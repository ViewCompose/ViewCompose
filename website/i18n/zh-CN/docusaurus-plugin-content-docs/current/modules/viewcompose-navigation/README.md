...
- 直接 ViewCompose 依赖包括 navigation core、host Android、renderer、widget core、lifecycle
  和 ViewModel 集成。
...
完整生成参考位于
[`viewcompose-navigation` API 树](https://docs.viewcompose.com/api/viewcompose-navigation/current/)。
