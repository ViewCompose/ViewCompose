...
translation_source_hash: 0bd147d16a5986f13fba811e0e96cf126849deb0310f2101e3f4d22c91cf62a8
...
全局侧边栏只链接“架构决策记录”索引，不在每一个渲染页面重复所有 ADR。双语索引仍是完整的有序
目录，每个决策仍可直接访问、搜索，并由该索引链接。这样，新增不可变决策不会把导航标签成倍复制
到整个站点产物中。
